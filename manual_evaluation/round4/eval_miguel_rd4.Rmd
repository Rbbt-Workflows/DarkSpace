...
g5 <- ggplot(manual_ori_sel_long,aes(x=relevance,fill=contains_interactions))
g5 <- g5 + geom_histogram(alpha=0.8,position='stack')
g5 <- g5 + xlab("relevance score")
g5 <- g5 + ylab("Number of publications")
g5 <- g5 + ggtitle("Manual evaluation by relevance score and round")
g5 <- g5 + facet_grid(origin~round,scales="free")
