...
g4.1 <- g4.1 + ylab("Number of publications")
...
grid.arrange(g1.1, g2.1, g3.1, g4.1, ncol=1)
```
...
g5.2 <- g5.2 + xlab("relevance score")
g5.2 <- g5.2 + ylab("Number of publications")
...
g5.3 <- g5.3 + xlab("relevance score")
...
g5.4 <- g5.4 + ylab("Number of publications")
...
grid.arrange(g5.1, g5.2, g5.3, g5.4, ncol=1)
```
